...
function Contact() {
  ...
  const Submited = (e) => {
    ...
    Set_disabled(1);
    http
      .post("/store_contact", Data)
      .then((res) => {
        notify(res.data.save);
        Set_disabled(0);
      })
      .catch((error) => {
        Set_disabled(0);
                  ...
                  <div className="contact__info border-radius-10">
                    ...
                    <div className="contact__info--items">
                      ...
                      <div className="contact__info--items__inner d-flex">
                        ...
                        <div className="contact__info--content">
                          <p className="contact__info--content__desc text-white">
                            <a href="mailto:md.royalmarriagebureau@gmail.com">
                              md.royalmarriagebureau@gmail.com
                            </a>
                            <br />
                            {/* <a href="mailto:md.royalmarriagebureau@gmail.com">
                              md.royalmarriagebureau@gmail.com
                      ...
                      <ul className="contact__info--social d-flex">
                        <li className="contact__info--social__list">
                          <a
                            ...
                            target="_blank"
                            href="https://www.facebook.com/profile.php?id=100090053242512"
                          >
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              width="7.667"
                        ...
                        <li className="contact__info--social__list">
                          <a
                            className="contact__info--social__icon"
                            target="_blank"
                            href="https://youtube.com/@royalmarriagebureau9076"
                          >
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              width="16.49"
