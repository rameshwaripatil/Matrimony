...
const Groom = () => {
  ...
  const getCasts = () => {
    http
      .get(`/member/imformation/for_fillter`)
      .then((res) => {
    ...
    <>
      ...
      <div>
        ...
        <section className="team__section my-4">
          <div className="containerrr p-3 font-weight-bold">
            <h3>Cast:</h3>
          </div>
          ...
          {viewcast === 1 ? (
            <div className="containerff p-3">
              <div className="row ">
                <div className=" ">
                  <div className="text-center">
                    <input
                      className="m-1 w-50  mt-3"
                ...
                {cast
                  .filter((el) => {
                    if (searchTerm === "") {
                      ...
                      el.caste.toLowerCase().includes(searchTerm.toLowerCase())
                    ) {
                      return true;
                    }
                    return false;
                  })
                  .slice(offset, offset + displayCount)
                  .map((el) => (
                    <a
                      className="bg-danger text-white text-center align-items-center m-auto w-75 p-4 mt-3"
                      href="/view_by_cast/1/1/Not Assign"
                      key={el.caste}
                    >
                      {el.caste}
                    </a>
                            ...
                            <div key={index}>
                              <div className="teamcard--thumbnail mx-auto">
                                {el.member_user_img1 != null ? (
                                  <img
                                    className="teamcard--thumbnail__img display-block"
                                    src={`https://admin.royalmarriagebureau.com/uploads/userimg/${el.member_user_img1}`}
                                    alt="team-thumb"
                                    style={{ height: "300px" }}
                                  />
                                ) : (
                                  <img
                                    className="teamcard--thumbnail__img display-block"
                                    src="https://royalmarriagebureau.com/static/media/profie_photo.2d5685846284c2a66537.jpg"
                                    alt="team-thumb"
                                    style={{ height: "300px" }}
                                  />
                                )}
                              ...
                              <table className="mt-4 mx-auto">
                                <tbody>
                                  ...
                                  <TableRow
                                    label="Education"
                                    value={el.member_highest_education}
                                  />
                                  <TableRow
                                    label="Employed In"
                                    value={el.member_employed_in}
                                  />
                                  <TableRow
                                    label="Income"
                                    value={el.member_annual_income}
                                  />
                                  <TableRow
                                    label="Village"
                                    value={el.village_name}
                                  />
                                </tbody>
                              </table>
                              <div className="text-center mt-4">
