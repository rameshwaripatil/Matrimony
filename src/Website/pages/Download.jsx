    ...
    return (
        <div class="container">
            <div class="row row-cols-md-2 row-cols-1  align-items-center">
                <div class="col"><div class="image__with--text__thumbnail">
                    <img class="display-block" src="/static/media/slider2.6c5b2deb9eb3eae159ca.jpg" alt="drone-image" />
                        ...
                        <div class="image__with--text__percent color-primary-2 mb-40"><ul><li class="image__with--text__percent--list mb-25">
                            <span class="image__with--text__percent--top d-flex justify-content-between align-content-center">
                                <h2>Download App Now !</h2></span></li></ul></div><div class="image__with--text__content--footer d-flex">
                                    <img class="display-block" src="/static/media/text-shape.b74012aa0a0c8e3dcb4f.webp" alt="text-shape" /></div>
                                    </div>
                                    </div>
                                    </div>
                                    </div>
